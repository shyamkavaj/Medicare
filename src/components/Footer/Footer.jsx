...
const socialLinks = [
      {
            path: "https://www.youtube.com/watch?v=yrW05J_u6lU",
            ...
            <section className='pb-16 pt-10'>
                  <div className='container'>
                        <div className='flex justify-between flex-col md:flex-row flex-wrap gap-[30px] '>
                              <div>
                                    <img src={logo} alt="" />
                                    <p className='text-[16px] leading-7 font-[400] text-textColor mt-4 '>Copyright {year} developed by Shyam Kava all right reserved.
                                    </p>
